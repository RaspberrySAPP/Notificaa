...
<head>
    <meta charset="utf-8">
    <title>Notificca.io</title>
    <?php wp_head();?>
    <!--/tags -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    	<meta name="keywords" content="Notificca" />
    ...
    <script src="js/notificca-animation.js"></script>
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a href="#">  
            <h1>
                <img class="img" style="max-height:50px" src="/images/notificca_logo.png" />
                <span class="logo-text">Notificca</span>
            </h1>
          </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="#" class="effect-3">Home</a></li>
                <!-- <li><a href="/pricing" class="effect-3 page-scroll">Pricing</a></li> -->
                <li><a href="/contact-us" class="effect-3 page-scroll">Contact Us</a></li>
          </ul>
          </nav>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
